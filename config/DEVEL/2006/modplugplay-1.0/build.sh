...
#		echo "$0: CONFIGURE: Configuration not determined" 1>&2
	...
	if [ -d ${FR_LIBCDIR}/include/libmodplug ] ; then
		# toolchain 0.7.x and later
		ADD_INCL_MODPLUG='-I'${FR_LIBCDIR}'/include/libmodplug'
		# ADD_LIBC_MODPLUG='-L'${FR_LIBCDIR}'/lib -lncurses'
	else
