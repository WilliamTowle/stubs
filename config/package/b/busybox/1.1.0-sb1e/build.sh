#!/bin/sh
# 01/08/2007 (EARLIEST v0.60.2, c.11/10/2002)
...
# BUILD/INSTALL
	...
	;;
	1.1.0)
		## bb_config.h builds badly on Ubuntu Edgy
		make include/bb_config.h || exit 1
		mv include/bb_config.h include/bb_config.h.OLD || exit 1
		cat include/bb_config.h.OLD \
			| sed '/ifndef BB_CONFIG_H/	s/-e //' \
			> include/bb_config.h || exit 1
		make || exit 1
	;;
	1.2.2.1|1.4.1)
		make || exit 1
