#!/usr/bin/make
# hb_qdtc-ucldev v0.9.33   	STUBS (c) and GPLv2 1999-2014
...
# - UCLIBC_HAS_{LOCALE|WCHAR} required by libX11
...
## ... -Wall, implies -Warray-bounds; gen_wc8bit is problematic

## [2014-05-05] LOCALE,WCHAR *temp'ly unset* - Debian issue?
...
${CTI_UCLDEV_CONFIGURED}:
	( cd source/uClibc-${PKGVER} || exit 1 ;\
		( \
		 ...
		 echo '# failed-alone: UCLIBC_HAS_GETPT=y' ;\
...
# LOCALE/WCHAR for libX11
#		 echo 'UCLIBC_HAS_LOCALE=y' ;\
#		 echo 'UCLIBC_HAS_WCHAR=y' ;\
# LOCALE/WCHAR prompt Debian issue?
#		 echo '# UCLIBC_HAS_LOCALE is not set' ;\
