# kstc-lx26config 2.6.28	[ since v2.0.37pre10, c.2002-10-14 ]
...
CTI_LX26CONFIG_INSTALLED= ${CTI_ROOT}/etc/config-linux26-${PKG_VER}
...
${CTI_LX26CONFIG_INSTALLED}: ${CTI_ROOT}
	echo "*** $@ (INSTALLED) ***"
	( cd ${EXTTEMP}/${CTI_LX26CONFIG_TEMP} || exit 1 ;\
		mkdir -p ` dirname ${CTI_LX26CONFIG_INSTALLED} ` || exit 1 ;\
