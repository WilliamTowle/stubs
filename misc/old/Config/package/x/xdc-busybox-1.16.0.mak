## busybox v1.16.0		[ EARLIEST v0.??.?, c.????-??-?? ]
## last mod WmT, 2010-03-10	[ (c) and GPLv2 1999-2010 ]
...
FUDGE_BUSYBOX_HTC_GCC=i686-host-linux-uclibc-gcc
FUDGE_BUSYBOX_CROSS_TRIPLET=lungching-linux-uclibc
	...
	( cd ${EXTTEMP}/${CUI_BUSYBOX_TEMP} || exit 1 ;\
		(	case ${PKG_VER} in \
			1.16.0) \
				...
				echo 'CONFIG_CROSS_COMPILER_PREFIX="'${TARGET_CPU}-${FUDGE_BUSYBOX_CROSS_TRIPLET}'-"' ;\
				\
